...
BARRIER computes activation intervals from the **forget set** and protects everything **outside** those intervals (negative space). This allows unlearning specific classes while preserving all other knowledge, without needing retain set data during training.
