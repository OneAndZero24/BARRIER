...
RESULTS_BASE="${SCRATCH:-$HOME}/intact/DDPM/ablation_svd_pca_raw"
...
# Scratch paths
cfg["paths"]["pretrained_ckpt_folder"] = "$SCRATCH/intact/DDPM/results/cifar10/2026_01_13_220000"
...
cfg["paths"]["ref_dataset_dir"] = "$SCRATCH/intact/DDPM/results/cifar10_without_label_0"
cfg["paths"]["classifier_ckpt"] = "$SCRATCH/intact/DDPM/models/cifar10_resnet34.pth"
