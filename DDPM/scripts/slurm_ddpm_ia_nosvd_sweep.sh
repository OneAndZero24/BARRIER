#!/bin/bash
# ============================================================================
# SLURM -- DDPM CIFAR-10 InTAct Ablation: IA no SVD (50 runs)
# ============================================================================
# Usage:
#   cd DDPM
#   sbatch scripts/slurm_ddpm_ia_nosvd_sweep.sh
# ============================================================================

#SBATCH --job-name=ddpm-ia-nosvd
#SBATCH --qos=big
#SBATCH --gres=gpu:1
...
echo "Starting IA-noSVD ablation sweep (50 runs) on $(hostname)"

SWEEP_OUT=$(wandb sweep configs/sweep_ia_nosvd.yaml 2>&1)
echo "$SWEEP_OUT"
