...
#   seed:        0 1 2
#
# Each job appends a row to results/regions.csv and per-layer diagnostics to
# results/diagnostics.csv (created under DDPM/results/).  After all jobs:
#   python ablation_regions.py --summarize --results_dir ./results
# -> writes results/regions_table.tex
#
