#!/bin/bash
# ============================================================================
# SLURM – DDPM CIFAR-10 InTAct GA Bayesian Sweep (50 runs via wandb agent)
# ============================================================================
# Usage:
#   cd DDPM
#   sbatch scripts/slurm_ddpm_ga_sweep.sh
# ============================================================================

#SBATCH --job-name=ddpm-ga-sweep
#SBATCH --qos=big
#SBATCH --gres=gpu:1
...
echo "Starting GA bayesian sweep (50 runs) on $(hostname)"

wandb agent $(wandb sweep configs/sweep_ga_bayes.yaml 2>/dev/null | grep -o 'wandb agent .*') --count 50
