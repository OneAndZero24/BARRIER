#!/bin/bash
# ============================================================================
# SLURM -- DDPM CIFAR-10 InTAct Ablation: PCA + intervals (50 runs)
# ============================================================================
# Usage:
#   cd DDPM
#   sbatch scripts/slurm_ddpm_pca_ia_sweep.sh
# ============================================================================

#SBATCH --job-name=ddpm-pca-ia
#SBATCH --qos=big
#SBATCH --gres=gpu:1
...
echo "Starting PCA-IA ablation sweep (50 runs) on $(hostname)"

SWEEP_OUT=$(wandb sweep configs/sweep_pca_ia.yaml 2>&1)
echo "$SWEEP_OUT"
