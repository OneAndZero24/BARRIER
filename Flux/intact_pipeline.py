...
def configure_wandb_paths():
    """Keep wandb data and temp files off the home filesystem when possible."""
    scratch_base = os.environ.get("SCRATCH", os.path.expanduser("~/.cache"))
    cache_root = os.environ.get("CACHE_ROOT", os.path.join(scratch_base, ".cache"))
    os.environ.setdefault("XDG_DATA_HOME", cache_root)
    os.environ.setdefault("XDG_CACHE_HOME", cache_root)
    os.environ.setdefault("WANDB_DIR", os.path.join(cache_root, "wandb"))
    os.environ.setdefault("WANDB_CACHE_DIR", os.path.join(cache_root, "wandb"))
    os.environ.setdefault("TMPDIR", os.path.join(cache_root, "tmp"))
