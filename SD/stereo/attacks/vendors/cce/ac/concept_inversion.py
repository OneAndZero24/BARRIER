...
def parse_args():
    ...
    #esd arguments
    parser.add_argument("--ac_checkpoint", type=str, default="", help="checkpoint for esd")
...
def main():
    ...
    if(args.ac_checkpoint != ""):
        pipe_tmp = CustomDiffusionPipeline.from_pretrained(args.pretrained_model_name_or_path, torch_dtype=torch.float16, safety_checker=None,).to("cuda")
