...
def _postprocess(output, resize_factor, pad_left, pad_top):
    ...
    for i in indices:
        ...
        detections.append({"class": __labels[class_id], "score": float(score), "box": box})
    return detections
...
class NudeDetector:
    def __init__(self):
        ...
        self.onnx_session = onnxruntime.InferenceSession(
            '/vhome/gongchao/UCE_acceleration/adv-train/utils/metrics/nudenet/best_new.onnx',
    ...
    def detect(self, image_path):
        preprocessed_image, resize_factor, pad_left, pad_top = _read_image(image_path, self.input_width)
