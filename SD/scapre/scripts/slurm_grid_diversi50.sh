...
# Each job: train → evaluate using ScaPre protocol (Table 3).
#
# Usage:
#   cd SD
#   sbatch scapre/scripts/slurm_grid_diversi50.sh
# ============================================================================

#SBATCH --job-name=bar-g-dv50
#SBATCH --gres=gpu:1
...
echo "============================================"
echo "Diversi50 Grid – combo ${TASK_ID} on $(hostname)"
...
echo "Diversi50 grid combo ${TASK_ID} (${MODEL_NAME}) done."
